  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Review customer booking requests, dispatch appointments, and complete jobs with CoopServe Protected 88% direct earnings."
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row lg:flex-col items-start sm:items-center lg:items-end justify-between gap-3 pt-3 lg:pt-0 border-t lg:border-t-0 border-slate-100 shrink-0">
                  <div className="text-left lg:text-right">
                    <span className="text-[10px] text-slate-400 uppercase font-bold block">Your Net Payout (88%)</span>
